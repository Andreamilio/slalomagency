    ...
    <section className="scroll-line-section" id="scrollLine" ref={sectionRef}>
      <div className="scroll-line-wrap">
        <svg viewBox="0 0 1400 800" preserveAspectRatio="xMidYMid slice">
          ...
          <path
            id="scrollPathBg"
            d="M -50,400 C 50,50 200,50 330,400 C 460,750 940,750 1070,400 C 1200,50 1380,50 1500,400"
          />
          <path
            ref={pathRef}
            id="scrollPath"
      ...
      <div className="reveal" style={{ position:'relative', zIndex:2, textAlign:'center', padding:'0 24px' }}>
        ...
        <p style={{ color:'var(--muted)', marginTop:20, fontSize:15, maxWidth:420, marginLeft:'auto', marginRight:'auto', lineHeight:1.7 }}>
